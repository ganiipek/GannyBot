...
namespace GannyBot
{
    ...
    {
        public UniswapRouterDeployment() : base(BYTECODE) { }
        public UniswapRouterDeployment(string byteCode) : base(byteCode) { }
    }

    public class UniswapRouterDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public UniswapRouterDeploymentBase() : base(BYTECODE) { }
        public UniswapRouterDeploymentBase(string byteCode) : base(byteCode) { }
